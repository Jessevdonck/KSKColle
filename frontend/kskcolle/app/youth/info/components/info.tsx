          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
            ...
            <div className="lg:col-span-2 space-y-3 text-textColor">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="bg-mainAccent/5 rounded-lg p-3 border-l-4 border-mainAccent">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="rounded-lg p-3 border border-neutral-200 bg-gradient-to-br from-neutral-50 to-neutral-100">

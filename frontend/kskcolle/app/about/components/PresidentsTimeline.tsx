...
const Presidents = () => {
  return (
    <section className="mb-16">
      ...
      <div className="relative border-l-4 border-mainAccent ml-4">
        {presidents.map((president, index) => (
          <div key={index} className="mb-8 ml-6">
            <div className="absolute w-3 h-3 bg-mainAccent rounded-full mt-1.5 -left-1.5"></div>
            <time className="mb-1 text-sm font-normal leading-none text-mainAccent">{president.period}</time>

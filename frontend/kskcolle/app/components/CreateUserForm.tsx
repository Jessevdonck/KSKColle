...
import { Calendar, UserPlus, CheckCircle, AlertCircle, User, Mail, Trophy, Shield, MapPin, Building, PenTool, Puzzle } from 'lucide-react';
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-3">
            <Checkbox
              ...
              data-cy="create_user_is_puzzlemaster_checkbox"
            />
            <Label htmlFor="is_puzzlemaster" className={`text-sm font-medium flex items-center gap-2 ${watch("roles").includes("exlid") ? "text-gray-400" : "text-gray-700"}`}>

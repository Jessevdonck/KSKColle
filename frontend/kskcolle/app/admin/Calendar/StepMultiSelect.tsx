...
const StepMultiSelect: React.FC<StepMultiSelectProps> = ({
  ...
  const availableSteps = [
    { id: "Stap 1", label: "Stap 1", color: "bg-yellow-50 text-yellow-600 border-yellow-200" },
    { id: "Stap 2", label: "Stap 2", color: "bg-yellow-100 text-yellow-800 border-yellow-300" },

...
export default function MegaschaakPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-4">
            ...
            <div className="text-xs sm:text-sm text-gray-700 space-y-1.5 sm:space-y-2">
              <p className="leading-relaxed">
                <strong>•</strong> Elke deelnemer dient een ploeg in ter waarde
                van <strong>max. 1000 punten</strong>
              </p>
              <p className="leading-relaxed">
              ...
              <p className="leading-relaxed">
                ...
                ter waarde van <strong>max. 100 punten</strong>
              </p>
              <p className="leading-relaxed">
                <strong>•</strong> Bij uitval wordt de reservespeler automatisch
                vervangen (score vanaf moment van vervanging)
              </p>
              <p className="leading-relaxed">
                <strong>•</strong> De waarde van elke schaker staat hieronder
                vermeld alsook in welke afdeling ze spelen.
              </p>
              <p className="leading-relaxed">
                <strong>•</strong> <strong>Winst = 1 punt</strong>,{" "}
                <strong>Remise = 0,5 punt</strong>,{" "}
                <strong>Verlies = 0 punt</strong>
              </p>
              <p className="leading-relaxed">
                <strong>•</strong> Deelname kost <strong>€2,50</strong> per
                ingestuurde ploeg, meerdere ploegen per persoon zijn toegestaan
              </p>
              <p className="leading-relaxed">
                <strong>•</strong> Prijzen voor de <strong>top 3</strong> uit de
                ingezamelde bijdragen
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Main Content */}
      <div
        className={`${activeView === "crosstable" ? "max-w-[95vw]" : "max-w-7xl"} mx-auto px-6 sm:px-8 lg:px-12 py-8`}
      >
        {!isRegistrationClosed && activeView !== "team" ? (
          ...
          <CrossTableView data={crossTableData} isLoading={crossTableLoading} />
        ) : activeView === "standings" ? (
          <StandingsView standings={standings} isLoading={standingsLoading} />
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700">
                  ...
                  . Je hebt geen teams ingediend. Bekijk de stand om te zien hoe
                  andere teams het doen!
                </p>
              </div>
            </div>
          </div>
...
function CrossTableView({
  ...
  const sortedClassEntries = Object.entries(playersByClass).sort(
    ([classA], [classB]) => {
